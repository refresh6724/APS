...
public class Main_JO_1106_장기 { // 제출일 2021-05-21 22:31
	...
	private static void input() throws Exception {
		...
		n = Integer.parseInt(st.nextToken()) - 1; // 장기판 행의 수 1 이상, 100 이하
		m = Integer.parseInt(st.nextToken()) - 1; // 장기판 열의 수 1 이상, 100 이하
