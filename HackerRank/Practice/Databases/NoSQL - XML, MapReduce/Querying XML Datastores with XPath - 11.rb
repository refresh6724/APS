...
listing the titles of the movies which occur at odd positions in the XML, 
in the same order as which they occur in the given XML (i.e, the first record, third record, etc.).
